<template>
    <div>
        <el-page-header
         @back="goBack"
        ></el-page-header>
        <h2 style="text-align:center" ref="h2">{{blogData.title}}</h2>
        <el-card>
            <div slot="header" class="clearfix">
                <el-row>
                    ...
                    <el-col :span=4>
                        ...
                        <br>
                        <span style="font-size:14px;color:#909399">{{blogData.lastModified | transformTime}} </span>
                    </el-col>
                    <el-col :span=7 :offset="12">
                        <el-button
                            :style="userData.userDetail.likes.includes(blogId)?'color:red':''"
                        ...
                        <el-button 
                            ...
                            v-if="!(blogData.author.userName === userData.userName)"
                        >{{ userData.userDetail.blacklist.includes(blogData.author.userName) ? '已拉黑' : '拉黑' }}</el-button>
                        <el-button 
                            type="danger"
                            icon="el-icon-thumb"
                            @click="switchTipOff"
            ...
            <el-row style="font-size:14px">
                <el-col :span=2><i class="el-icon-mobile-phone">{{blogData.likes}}</i></el-col>
                <el-col :span=2><i class="el-icon-mobile-phone">{{blogData.views}}</i></el-col>
                <el-col :span=2><i class="el-icon-mobile-phone">{{blogData.comment.length}}</i></el-col>
            </el-row>
        ...
        <el-dialog
            ...
            width="30%"
        >
            <el-input type="textarea" v-model="tipOffReason" placeholder="请输入举报内容"></el-input>
            <span slot="footer" class="dialog-footer">
                <el-button @click="isShowTipOff=false">取消</el-button>
                <el-button  type="primary" @click="switchTipOff">确定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    created(){
        this.blogId=Number(this.$route.params.id); //从router.params接收到的是字符串
    ...
    methods:{
        ...
        switchLike(){
            ...
            // 修改本地sessionStorage数据
                ...
                tempData.userDetail.likes.splice(tempData.userDetail.likes.indexOf(this.blogId),1);
        ...
        switchTipOff(){
            ...
            authorName:this.blogData.author.userName
            };
